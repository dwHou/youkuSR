...
def make_model(args):
    return EDVR(args.n_feats, args.n_frames, args.n_groups, args.front_RBs, args.back_RBs, args.n_resblocks, args.n_resgroups)
...
class EDVR(nn.Module):
    def __init__(self,
        ...
        recon2 = [ResidualGroup(nf, n_resblocks) for i in range(n_resgroups)]
